...
HTMLでPowerPoint風スライド(16:9 / 1280×720px)を1枚単位で作るためのスキルと、63種のレイアウトパターン実例集。
...
.github/skills/html-slide/   # スキル本体(GitHub Copilot用・マスター)
  ...
  references/pattern-guide.md#   63パターンの選択ガイド(判定フロー)
...
slides/                      # 実例63枚(slide-*.html)+ gallery.html + previews/*.png
```
